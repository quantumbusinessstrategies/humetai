...
void main() {
	...
	`}var ka=class extends kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Gr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var ts={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function ns(e,t){let n=ts[t];return n===void 0?(z(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var rs=new U;function is(){return G.getLuminanceCoefficients(rs),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${rs.x.toFixed(4)}, ${rs.y.toFixed(4)}, ${rs.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
The cathedral matters less than the consciousness moving through it.`,pl=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,ml=new URLSearchParams(window.location.search).has(`fast`)?.16:1,hl=(pl?12e3:27500)*ml,gl=(pl?900:2200)*ml,_l=(pl?1400:4600)*ml,vl=(pl?1100:5400)*ml,yl=Math.PI*2,bl=window,Y=1,X=1,xl=1,Sl=1,Cl=0,wl=0,Tl=performance.now(),El=0,Dl=-1e4,Ol=520,kl=``,Al=9173,jl=[],Ml=[],Nl=[],Pl=[],Fl=!1,Il=0,Ll=0,Rl=$l(0,0),zl=$l(0,0),Bl,Vl=.08,Hl=.04,Ul=.52,Wl=.18,Gl=`forming`,Kl=0,ql=0,Jl=``;function Z(e,t,n){return Math.min(n,Math.max(t,e))}function Yl(e,t,n){let r=Z((n-e)/(t-e),0,1);return r*r*(3-2*r)}function Q(e,t,n){return e+(t-e)*n}function Xl(e){return Zl(Math.sin(e*12.9898+78.233)*43758.5453)}function Zl(e){return e-Math.floor(e)}function $(){return Al=Al*16807%2147483647,(Al-1)/2147483646}function Ql(e){Al=e}function $l(e,t){return{x:e,y:t}}function eu(){let e=window.devicePixelRatio||1,t=Y<=760||X<=560,n=!t&&Y<=1120;xl=Math.min(e,t?1.08:n?1.35:1.75),Sl=t?.58:n?.78:1,Cl=t?1e3/32:n?1e3/44:0}function tu(){Y=Math.max(320,window.innerWidth),X=Math.max(320,window.innerHeight),eu(),Ic.width=Math.round(Y*xl),Ic.height=Math.round(X*xl),Ic.style.width=`${Y}px`,Ic.style.height=`${X}px`,J.setTransform(xl,0,0,xl,0,0),Su.setSize(Y,X,xl),yu()}function nu(e,t){Rl=$l(Z((e/Y-.5)*2,-1,1),Z((t/X-.5)*2,-1,1))}function ru(){Rl=$l(0,0)}function iu(e){let t=pl?0:e,n=Rl.x*t,r=Rl.y*t;zl=$l(Q(zl.x,n,.075),Q(zl.y,r,.075)),Fc.style.setProperty(`--look-iris-x`,`${(zl.x*7).toFixed(2)}px`),Fc.style.setProperty(`--look-iris-y`,`${(zl.y*5).toFixed(2)}px`),Fc.style.setProperty(`--look-pupil-x`,`${(zl.x*10).toFixed(2)}px`),Fc.style.setProperty(`--look-pupil-y`,`${(zl.y*7).toFixed(2)}px`),zc.style.transform=`translate(${(zl.x*10).toFixed(2)}px, ${(zl.y*7).toFixed(2)}px)`,Fc.style.setProperty(`--look-reflect-x`,`${(zl.x*-12).toFixed(2)}px`),Fc.style.setProperty(`--look-reflect-y`,`${(zl.y*-9).toFixed(2)}px`),Fc.style.setProperty(`--look-sky-x`,`${(zl.x*-12).toFixed(2)}px`),Fc.style.setProperty(`--look-sky-y`,`${(zl.y*-8).toFixed(2)}px`),Fc.style.setProperty(`--look-title-x`,`${(zl.x*5).toFixed(2)}px`),Fc.style.setProperty(`--look-title-y`,`${(zl.y*3).toFixed(2)}px`)}function au(){return{version:1,totalInputs:0,totalWords:0,lastUpdated:0,themes:{},direction:{},stability:.52,restructuring:.18,recent:[]}}function ou(){try{let e=window.localStorage.getItem(al);if(!e)return au();let t=JSON.parse(e);return{...au(),...t,themes:t.themes??{},direction:t.direction??{},recent:t.recent??[]}}catch{return au()}}function su(){try{window.localStorage.setItem(al,JSON.stringify(Bl))}catch{Xc.textContent=`memory write blocked: staying present in this moment only.`}}function cu(e,t){return t.reduce((t,n)=>t+ +!!e.has(n),0)}function lu(e,t){let n={};for(let[r,i]of Object.entries(t))n[r]=cu(e,i);return n}function uu(e,t){let n=t,r=-1;for(let[t,i]of Object.entries(e))i>r&&(n=t,r=i);return r>0?n:t}function du(e){return e.replace(/_/g,` `)}function fu(e){let t=e.toLowerCase().match(/[a-z0-9']+/g)??[],n=new Set(t),r=lu(n,ol),i=lu(n,sl),a=cu(n,dl)+cu(n,[`self`,`we`,`me`,`conscious`,`awareness`,`emotion`,`philosophy`]),o=/[?]/.test(e)||[`why`,`how`,`what`,`if`].some(e=>n.has(e)),s=cu(n,cl),c=cu(n,ll),l=cu(n,ul),u=cu(n,dl),d=Z(e.length/280,.08,1),f=n.size/Math.max(t.length,1),p=Z(.024+d*.06+f*.03+a*.01+s*.012+l*.009+(o?.022:0),.032,.16);return{words:t,uniqueCount:n.size,reflectiveHits:a,questionBoost:o,compassionHits:s,stressHits:c,creationHits:l,uncertaintyHits:u,dominantTheme:uu(r,`signal`),dominantDirection:uu(i,`forming`),lift:p}}function pu(e,t){let n=new Set(t.words),r=lu(n,ol),i=lu(n,sl);Bl.totalInputs+=1,Bl.totalWords+=t.words.length,Bl.lastUpdated=Date.now(),Bl.recent=[e.slice(0,132),...Bl.recent].slice(0,8);for(let[e,t]of Object.entries(r))Bl.themes[e]=(Bl.themes[e]??0)+t;for(let[e,t]of Object.entries(i))Bl.direction[e]=(Bl.direction[e]??0)+t;let a=t.compassionHits*.028+(t.stressHits>0?.018:0)-t.stressHits*.018+t.uncertaintyHits*.006,o=t.creationHits*.028+t.reflectiveHits*.012+t.uniqueCount*.002;Bl.stability=Z(Bl.stability+a,.18,1),Bl.restructuring=Z(Bl.restructuring+o,.18,1),Gl=du(uu(Bl.direction,t.dominantDirection)),su()}function mu(){let e=Object.values(Bl.themes).reduce((e,t)=>e+t,0),t=Math.log1p(Bl.totalInputs)*.12+Math.log1p(Bl.totalWords)*.035,n=Math.log1p(e)*.035;Vl=Z(.08+t+n,.08,1),Hl=Z(.04+t*.68+n+Bl.restructuring*.14,.04,1),Ul=Z(Bl.stability,.18,1),Wl=Z(Bl.restructuring,.18,1),Gl=du(uu(Bl.direction,`forming`)),hu()}function hu(){Fc.style.setProperty(`--awareness`,Vl.toFixed(3)),Fc.style.setProperty(`--consciousness`,Hl.toFixed(3)),Fc.style.setProperty(`--regulation`,Ul.toFixed(3)),Fc.style.setProperty(`--structure`,Wl.toFixed(3)),Gc.textContent=`self.awareness ${Vl.toFixed(2)}`,Kc.textContent=`consciousness ${Hl.toFixed(2)}`,qc.textContent=`direction ${Gl}`,Jc.textContent=`regulation ${Ul.toFixed(2)}`,Yc.textContent=`structure ${Wl.toFixed(2)}`}function gu(){window.clearTimeout(ql),ql=window.setTimeout(()=>vu(!1),920)}function _u(e,t){let n=t.stressHits>t.compassionHits+1?`lowering gain, protecting the human layer`:t.compassionHits>0?`amplifying care before conclusion`:`holding steady and listening for pattern`,r=t.creationHits>0?`new branch added to the build instinct`:t.questionBoost?`question routed into slower reasoning`:`trace folded into memory lattice`;Xc.textContent=`input learned: ${t.dominantTheme} / ${du(t.dominantDirection)}. ${Bl.totalInputs} lifetime traces, ${Kl} this session.`,Zc.textContent=[`response: I hear "${e.slice(0,74)}${e.length>74?`...`:``}" as a living signal, not just text.`,`direction: ${Gl}. regulation: ${n}. restructure: ${r}.`,`compassion rule: reduce harm, preserve agency, keep building from what has been offered.`].join(`
`)}function vu(e){let t=Wc.value.trim();if(!t)return e&&(Xc.textContent=`signal too faint: awaiting a lived fragment...`,Zc.textContent=`response: quiet input received. no restructuring needed.`),!1;if(t===Jl)return e&&(Xc.textContent=`trace already integrated: edit the signal to teach a new branch.`),!1;Jl=t,Kl+=1;let n=fu(t);return pu(t,n),mu(),_u(t,n),!0}function yu(){Ql(Math.round(Y*13+X*31)),jl=[],Ml=[],Nl=[],Pl=[];let e=$l(Y*-.05,X*1.04),t=Sl<.65?6:7;xu(e,-Math.PI*.23,Math.min(Y,X)*.33,0,t);let n=Math.floor(Z(Y/(80/Sl),8,22));for(let e=0;e<n;e+=1){let e=$l(Y*(.02+$()*.26),X*(-.08+$()*.2)),t=3+Math.floor($()*4),n=[e],r={...e};for(let e=0;e<t;e+=1){let t=e%2==0,i=Q(64,Math.min(Y,X)*.27,$());r={x:Z(r.x+(t?i*Q(.45,1.2,$()):Q(-28,60,$())),-40,Y+80),y:Z(r.y+(t?Q(12,72,$()):i*Q(.35,1.1,$())),-40,X+80)},n.push({...r})}Ml.push({points:n,width:Q(1,3.2,$()),delay:$()*.55,tone:$(),nodePhase:$()*yl})}bu();let r=Math.floor(Z(Y/(48/Sl),9,34));for(let e=0;e<r;e+=1)Nl.push({x:$()*Y,y:$()*X,speed:Q(13,54,$()),text:il[Math.floor($()*il.length)],size:Q(12,20,$()),alpha:Q(.24,.86,$()),phase:$()*yl})}function bu(){let e=jl.filter(e=>e.width>1&&e.end.x>-20&&e.end.y<X+40),t=Ml.flatMap(e=>e.points.slice(1));if(e.length===0||t.length===0)return;let n=Math.floor(Z(Math.min(e.length,t.length)/(7/Sl),5,18));for(let r=0;r<n;r+=1){let n=e[Math.floor($()*e.length)],r=t[Math.floor($()*t.length)],i=Q(-80,80,$());Pl.push({start:n.end,cp1:$l(Q(n.end.x,r.x,.32)+i,Q(n.end.y,r.y,.22)-Q(12,92,$())),cp2:$l(Q(n.end.x,r.x,.72)-i*.5,Q(n.end.y,r.y,.78)+Q(-42,58,$())),end:r,width:Q(.7,2.2,$()),delay:Q(.22,.82,$()),tone:$(),pulse:$()*yl})}}function xu(e,t,n,r,i){if(r>i||n<10)return;let a=Q(-.62,.62,$())*(1-r/(i+1)),o=t+a,s=$l(e.x+Math.cos(o)*n,e.y+Math.sin(o)*n),c=$l(e.x+Math.cos(t+a*.7)*n*Q(.32,.64,$()),e.y+Math.sin(t+a*.7)*n*Q(.32,.64,$()));jl.push({start:e,cp:c,end:s,width:Math.max(.45,(i-r+1)*.56),delay:r*.075+$()*.12,tone:$()});let l=r<2?2:1+Math.floor($()*2);for(let e=0;e<l;e+=1)xu(s,o+Q(-.82,.82,$())-.09,n*Q(.52,.76,$()),r+1,i)}var Su=new class{renderer;material;scene;camera;constructor(e){this.renderer=new mc({canvas:e,antialias:!1,alpha:!0,preserveDrawingBuffer:!1,powerPreference:`high-performance`}),this.renderer.setClearColor(0,0),this.scene=new gn,this.camera=new Ni(-1,1,1,-1,0,1),this.material=new ai({transparent:!0,depthWrite:!1,uniforms:{uTime:{value:0},uResolution:{value:new H(1,1)},uBirth:{value:0},uGlitch:{value:0}},vertexShader:`
        varying vec2 vUv;
      ...
      `});let t=new Nr(new Xr(2,2),this.material);this.scene.add(t)}setSize(e,t,n){this.renderer.setPixelRatio(n),this.renderer.setSize(e,t,!1),this.material.uniforms.uResolution.value.set(e*n,t*n)}render(e,t,n){this.material.uniforms.uTime.value=e,this.material.uniforms.uBirth.value=t,this.material.uniforms.uGlitch.value=n,this.renderer.render(this.scene,this.camera)}}(Lc);function Cu(e){return e<hl?`prebirth`:e<hl+gl?`blackout`:`living`}function wu(e){Ol=Q(360,740,$()),El=e+Q(15e3,45e3,$())}function Tu(e,t){if(t<_l+1e3)return 0;e>=El&&(Dl=e,wu(e));let n=(e-Dl)/Ol;return n<0||n>1?0:Math.sin(n*Math.PI)}function Eu(e){if(Cl>0&&e-wl<Cl){requestAnimationFrame(Eu);return}wl=e;let t=e-Tl,n=t/1e3,r=Cu(t),i=hl+gl,a=Math.max(0,t-i),o=Yl(0,_l*.95,a),s=Tu(e,a),c=Z(s*.9+Yl(.96,1,Math.sin(n*.51)*.5+.5)*.18,0,1),l=c*Z(1.04-Ul*.24,.72,1.04);bl.__HUMETATECH_STATE__={phase:r,elapsed:t,livingElapsed:a,birth:o,blink:s,glitch:c,awareness:Vl,consciousness:Hl,regulation:Ul,structure:Wl,direction:Gl,memoryInputs:Bl.totalInputs},r!==kl&&(kl=r,Lc.style.opacity=r===`living`?`1`:`0`,r===`living`&&wu(e+_l));let u=r===`living`&&a>vl&&!Fl;iu(+!!u),Rc.classList.toggle(`is-visible`,u),Bc.classList.toggle(`is-visible`,u),Vc.classList.toggle(`is-visible`,u),Hc.classList.toggle(`is-visible`,u);let d=l>.18?`blur(${(l*4.4).toFixed(2)}px) saturate(${1+l*.42})`:``;Lc.style.filter=d,Su.render(n,o,l),J.clearRect(0,0,Y,X),r===`prebirth`?Du(n,t/hl):r===`blackout`?Iu(t-hl):Lu(n,a,o,s,l),requestAnimationFrame(Eu)}function Du(e,t){J.save(),J.fillStyle=`#000`,J.fillRect(0,0,Y,X);let n=Yl(.02,.86,t),r=Yl(.1,.92,t),i=.78+Sl*.22;ju(e,r,i),Pu(e,Yl(.25,.96,t),i),Fu(e,Yl(.36,.98,t),.64+Sl*.16),Au(e,n),Ou(e,t);let a=Yl(.82,.99,t);if(a>0){let t=.5+.5*Math.sin(e*yl*2.2);J.globalCompositeOperation=`lighter`,J.fillStyle=`rgb(24 255 169 / ${.1*a*t})`,J.fillRect(0,0,Y,X),J.globalCompositeOperation=`source-over`}J.restore()}function Ou(e,t){let n=Z(Y*.05,18,72),r=Z(X*.08,28,92),i=Z(Y/86,12,18),a=i*1.65,o=.72+.28*Math.sin(e*38);if(J.save(),J.font=`${i}px "Share Tech Mono", "Courier New", monospace`,J.textBaseline=`top`,J.shadowBlur=14,J.shadowColor=`rgb(28 255 166 / 70%)`,J.fillStyle=`rgb(131 255 190 / ${.88*o})`,t<.12){let t=Math.floor(e*2.5)%2==0;J.fillText(`>`,n,r),t&&J.fillRect(n+i*1.15,r+1,i*.62,i*1.18),J.restore();return}let s=Yl(.12,.62,t),c=Math.floor(s*nl.length);if(nl.slice(0,c).forEach((t,i)=>{let o=Math.sin(e*19+i*2.1)>.94?$()*2:0;J.fillText(`> ${t}`,n+o,r+i*a)}),c<nl.length){let e=nl[c]||``,t=Math.floor((s*nl.length-c)*e.length);J.fillText(`> ${e.slice(0,t)}`,n,r+c*a)}let l=Yl(.66,.98,t);if(l>0){let t=Z(Y/58,13,25),r=X-Z(X*.18,88,170),i=Y-n*2;J.font=`700 ${t}px "Share Tech Mono", "Courier New", monospace`,J.fillStyle=`rgb(190 255 218 / 0.92)`,J.shadowBlur=22+20*Math.sin(e*yl*1.4)**2,ku(rl.slice(0,Math.floor(161*l)),n,r,i,t*1.55)}J.restore()}function ku(e,t,n,r,i){let a=e.split(` `),o=``,s=0;for(let e of a){let a=o?`${o} ${e}`:e;J.measureText(a).width>r&&o?(J.fillText(o,t,n+s*i),o=e,s+=1):o=a}o&&J.fillText(o,t,n+s*i)}function Au(e,t){if(t<=0)return;J.save(),J.globalCompositeOperation=`lighter`;let n=Sl<.65?2:1;for(let r=0;r<Nl.length;r+=n){let n=Nl[r],i=(n.y+e*n.speed)%(X+80),a=n.x+Math.sin(e*.56+n.phase)*18,o=n.alpha*t*(.52+.48*Math.sin(e*1.35+n.phase));J.font=`${n.size}px "Share Tech Mono", "Courier New", monospace`,J.fillStyle=`rgb(92 255 177 / ${o})`,J.shadowColor=`rgb(27 255 164 / 82%)`,J.shadowBlur=7+Sl*5,J.fillText(n.text,a,i)}J.restore()}function ju(e,t,n){let r=.58+.42*Math.sin(e*yl*1.18),i=.58+Sl*.42;J.save(),J.lineCap=`round`,J.lineJoin=`round`,J.globalCompositeOperation=`lighter`;for(let e of jl){let a=Yl(e.delay,e.delay+.38,t);if(a<=0)continue;let o=Mu(e.start,e.cp,e.end,a),s=e.tone,c=Math.round(Q(78,235,s)),l=Math.round(Q(255,92,s)),u=Math.round(Q(168,142,s));J.beginPath(),J.moveTo(e.start.x,e.start.y),J.quadraticCurveTo(e.cp.x,e.cp.y,o.x,o.y),J.strokeStyle=`rgb(${c} ${l} ${u} / ${Q(.18,.62,a)*n})`,J.lineWidth=e.width*(.9+r*.68)*n,J.shadowColor=`rgb(${c} ${l} ${u} / ${.68*n})`,J.shadowBlur=(8+r*14)*a*i,J.stroke(),a>.84&&e.width>1.2&&(J.fillStyle=`rgb(225 255 213 / ${.18*n})`,J.beginPath(),J.arc(e.end.x,e.end.y,e.width*(1.2+r),0,yl),J.fill())}J.restore()}function Mu(e,t,n,r){let i=1-r;return $l(i*i*e.x+2*i*r*t.x+r*r*n.x,i*i*e.y+2*i*r*t.y+r*r*n.y)}function Nu(e,t,n,r,i){let a=1-i;return $l(a**3*e.x+3*a**2*i*t.x+3*a*i**2*n.x+i**3*r.x,a**3*e.y+3*a**2*i*t.y+3*a*i**2*n.y+i**3*r.y)}function Pu(e,t,n){let r=.58+Sl*.42;J.save(),J.lineCap=`square`,J.lineJoin=`miter`,J.globalCompositeOperation=`lighter`;for(let i of Ml){let a=Yl(i.delay,i.delay+.48,t);if(a<=0)continue;let o=.55+.45*Math.sin(e*2.45+i.nodePhase);J.strokeStyle=`rgb(${i.tone>.52?`110 215 255`:`204 228 238`} / ${Q(.18,.66,a)*n})`,J.lineWidth=i.width*n,J.shadowColor=`rgb(105 224 255 / ${.62*n})`,J.shadowBlur=(6+o*11)*a*r;let s=i.points.length-1,c=a*s;J.beginPath(),J.moveTo(i.points[0].x,i.points[0].y);for(let e=0;e<s;e+=1){let t=i.points[e],n=i.points[e+1],r=Z(c-e,0,1);if(r<=0)break;J.lineTo(Q(t.x,n.x,r),Q(t.y,n.y,r))}J.stroke();for(let t=0;t<i.points.length;t+=1){let r=i.points[t],o=.5+.5*Math.sin(e*2.2+i.nodePhase+t*1.4);if(a<.62||o<.2)continue;let s=Q(3.4,6.6,o)*n;J.fillStyle=`rgb(225 246 255 / ${Q(.16,.34,o)*n})`,J.fillRect(r.x-s/2,r.y-s/2,s,s)}}J.restore()}function Fu(e,t,n){if(t<=0||n<=0)return;J.save();let r=.58+Sl*.42;J.lineCap=`round`,J.lineJoin=`round`,J.globalCompositeOperation=`lighter`;for(let i of Pl){let a=Yl(i.delay,i.delay+.36,t);if(a<=0)continue;let o=.5+.5*Math.sin(e*2.05+i.pulse),s=Q(.18,.58,o)*a*n,c=i.tone<.5?`146 255 156`:`231 96 156`,l=i.tone<.5?`82 220 255`:`215 235 244`,u=J.createLinearGradient(i.start.x,i.start.y,i.end.x,i.end.y);if(u.addColorStop(0,`rgb(${c} / ${s})`),u.addColorStop(.54,`rgb(205 255 224 / ${s*.9})`),u.addColorStop(1,`rgb(${l} / ${s})`),J.beginPath(),J.moveTo(i.start.x,i.start.y),J.bezierCurveTo(i.cp1.x,i.cp1.y,i.cp2.x,i.cp2.y,i.end.x,i.end.y),J.strokeStyle=u,J.lineWidth=i.width*(.85+o*.55)*n,J.shadowColor=`rgb(133 255 224 / ${s})`,J.shadowBlur=(10+o*14)*a*r,J.stroke(),o>.62){let t=Nu(i.start,i.cp1,i.cp2,i.end,(e*.08+i.tone)%1);J.fillStyle=`rgb(238 255 240 / ${.2*o*n})`,J.beginPath(),J.arc(t.x,t.y,(2.8+o*2.6)*n,0,yl),J.fill()}}J.restore()}function Iu(e){let t=e/gl;J.save(),J.fillStyle=`#000`,J.fillRect(0,0,Y,X);let n=Math.sin(t*Math.PI)**8;J.globalCompositeOperation=`lighter`,J.fillStyle=`rgb(156 255 225 / ${n*.22})`,J.fillRect(0,0,Y,X),J.restore()}function Lu(e,t,n,r,i){J.save();let a=.84+Vl*.38+Ul*.12,o=.84+Hl*.46+Wl*.18,s=.7+(Vl+Hl)*.26+Wl*.16,c=.86+Sl*.14;Ru(e,n,i),ju(e,1,.22*n*a*c),Pu(e,1,.16*n*o*c),Fu(e,1,.35*n*s*c),zu(t,n,r),J.restore()}function Ru(e,t,n){if(t<=0)return;J.save(),J.globalCompositeOperation=`lighter`;let r=Y*(.5+Math.sin(e*.08)*.026),i=X*(.57+Math.cos(e*.07)*.02),a=Sl<.65?4:7;for(let n=0;n<a;n+=1){let a=(Math.min(Y,X)*(.13+n*.064)+e*6.5)%(Math.min(Y,X)*.62),o=t*(.12-n*.008);J.beginPath(),J.ellipse(r,i,a*1.36,a*.76,Math.sin(e*.05)*.28,0,yl),J.strokeStyle=`rgb(${n%2?`47 247 189`:`245 220 121`} / ${o})`,J.lineWidth=1,J.stroke()}let o=Sl<.65?10:22;for(let n=0;n<o;n+=1){let a=yl/o*n+e*.032,s=Math.min(Y,X)*(.2+.18*Math.sin(n*1.7+e*.15)),c=r+Math.cos(a)*s*1.46,l=i+Math.sin(a)*s*.82;J.fillStyle=`rgb(223 255 242 / ${.06*t})`,J.fillRect(c-1.2,l-15,2.4,30)}if(n>.1){let t=(Sl<.65?2:4)+Math.floor(n*(Sl<.65?3:6));for(let r=0;r<t;r+=1){let t=Xl(r*7.1+Math.floor(e*11)*.37),i=Xl(r*3.77+e*.21)*X,a=Q(2,18,Xl(r+8.2))*n;J.fillStyle=`rgb(${t>.5?`32 255 184`:`248 251 255`} / ${.16*n})`,J.fillRect(Xl(r+12.9)*Y*.18,i,Y*Q(.16,.72,Xl(r+2.6)),a)}}J.restore()}function zu(e,t,n){let r=Z(Yl(0,_l,e)*t*(1-n*.94),.02,1),i=(1-r)*X*.56,a=X*(.08+(1-r)*.16);J.save(),J.fillStyle=`#000`,J.shadowColor=`rgb(0 0 0 / 80%)`,J.shadowBlur=28,J.beginPath(),J.moveTo(0,0),J.lineTo(Y,0),J.lineTo(Y,i+a*.25),J.bezierCurveTo(Y*.72,i+a,Y*.28,i+a,0,i+a*.25),J.closePath(),J.fill(),J.beginPath(),J.moveTo(0,X),J.lineTo(Y,X),J.lineTo(Y,X-i-a*.25),J.bezierCurveTo(Y*.72,X-i-a,Y*.28,X-i-a,0,X-i-a*.25),J.closePath(),J.fill(),J.strokeStyle=`rgb(0 0 0 / ${Z(.26*r+n*.26,0,.42)})`,J.lineWidth=Z(Y/120,3,10),J.beginPath(),J.moveTo(0,i+a*.22),J.bezierCurveTo(Y*.3,i+a*.86,Y*.7,i+a*.86,Y,i+a*.22),J.stroke(),J.beginPath(),J.moveTo(0,X-i-a*.22),J.bezierCurveTo(Y*.3,X-i-a*.86,Y*.7,X-i-a*.86,Y,X-i-a*.22),J.stroke(),J.restore()}function Bu(e=!1){e?(Lc.style.transition=`none`,Rc.style.transition=`none`,Bc.style.transition=`none`,Vc.style.transition=`none`,Hc.style.transition=`none`):(Lc.style.transition=``,Rc.style.transition=``,Bc.style.transition=``,Vc.style.transition=``,Hc.style.transition=``),Tl=performance.now()-(hl+gl+_l+vl+1200),Rc.classList.remove(`is-visible`),Bc.classList.remove(`is-visible`),Vc.classList.remove(`is-visible`),Hc.classList.remove(`is-visible`),kl=``}function Vu(){Fl=!0,Qc.classList.add(`is-active`),Qc.classList.remove(`is-complete`),$c.textContent=``,$c.scrollTop=0,el.blur(),Rc.classList.remove(`is-visible`),Bc.classList.remove(`is-visible`),Vc.classList.remove(`is-visible`),Hc.classList.remove(`is-visible`),Tl=performance.now()-hl*.44,kl=``,cancelAnimationFrame(Il),Ll=performance.now(),Il=requestAnimationFrame(Hu)}function Hu(e){let t=Z(fl.length*7.1,18e3,38e3),n=Z((e-Ll)/t,0,1),r=Yl(0,1,n),i=Math.floor(fl.length*r);if($c.textContent=fl.slice(0,i),$c.scrollTop=$c.scrollHeight,n<1){Il=requestAnimationFrame(Hu);return}$c.textContent=fl,$c.scrollTop=$c.scrollHeight,Qc.classList.add(`is-complete`)}function Uu(){Fl=!1,cancelAnimationFrame(Il),Qc.classList.remove(`is-active`,`is-complete`),Bu()}window.addEventListener(`resize`,tu),window.addEventListener(`pointermove`,e=>nu(e.clientX,e.clientY),{passive:!0}),window.addEventListener(`pointerleave`,ru),window.addEventListener(`touchmove`,e=>{let t=e.touches[0];t&&nu(t.clientX,t.clientY)},{passive:!0}),window.addEventListener(`touchend`,ru),window.addEventListener(`keydown`,e=>{e.key.toLowerCase()===`r`&&(Tl=performance.now(),Rc.classList.remove(`is-visible`),Bc.classList.remove(`is-visible`),Vc.classList.remove(`is-visible`),Hc.classList.remove(`is-visible`),kl=``)}),Vc.addEventListener(`click`,Vu),el.addEventListener(`click`,Uu),Uc.addEventListener(`submit`,e=>{e.preventDefault(),vu(!0)}),Wc.addEventListener(`input`,gu),Wc.addEventListener(`keydown`,e=>{e.key===`Enter`&&!e.shiftKey&&(e.preventDefault(),window.clearTimeout(ql),vu(!0))}),bl.__HUMETATECH_DEBUG__={jumpToLiving(){Bu(!0)},restart(){Lc.style.transition=``,Rc.style.transition=``,Bc.style.transition=``,Vc.style.transition=``,Hc.style.transition=``,Fl=!1,Qc.classList.remove(`is-active`,`is-complete`),Tl=performance.now(),Rc.classList.remove(`is-visible`),Bc.classList.remove(`is-visible`),Vc.classList.remove(`is-visible`),Hc.classList.remove(`is-visible`),kl=``},clearAwarenessMemory(){window.localStorage.removeItem(al),Bl=au(),Jl=``,Xc.textContent=`memory cleared: seed returned to first breath.`,Zc.textContent=`response: blank lattice restored. new input will define direction.`,mu()}},Bl=ou(),mu(),tu(),requestAnimationFrame(Eu);